...
async function userMove(board: string[][], player: string) {
...
let player: string = "X"// yaha player bataya ha ka player X hoga

let winner: boolean = false;  //Yaha say loop laga ha
